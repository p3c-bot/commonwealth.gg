...
function createGame(amountOfPlayers, entryCost) {
    ...
    lobby.createGame.sendTransaction(
        ...
        function (error, result) { //get callback from function which is your transaction key
            if (!error) {
                newGameID = parseInt(gameID) + 1
                newGameLink = 'https://commonwealth.gg/nodefornode.html?game=' + newGameID + "#"
...
function gameCreatedAlert(newGameID){
    ...
    `
    <h2 style="text-align:center;">
    New Game has been created! Click ok to copy link to clipboard. Page will redirect in 20 seconds. 
    </h2>
