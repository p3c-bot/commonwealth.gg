...
function getETCMessage(){
    alertify.confirm(
        ...
        <li>Moonpay: <a target="_blank" href="https://www.moonpay.io/">Buy or Sell ETC for Fiat (USD/EUR)</a></li>
        <li>Changelly: <a target="_blank" href="https://buy.changelly.com/?defaultCurrencyCode=etc&baseCurrencyCode=usd&baseCurrencyAmount=50">Buy ETC with Fiat (USD/EUR)</a></li>
        <li>Coinbase: <a target="_blank" href="https://www.coinbase.com/signup"> Buy or Sell ETC for Fiat (USD/EUR)</a></li>
        <li>Binance: <a target="_blank" href="https://www.binance.com/en/trade/ETC_BTC">Buy or Sell ETC for Crypto (BTC/USDC)</a></li>
        </h4>
        </ul>
