...
function getMyCrop(onboard) {
    ...
    if (myCropAddress === null) {
        farmContract.myCrop.call(function (err, result) {
            ...
            if (onboard && (err || (result == '0x0000000000000000000000000000000000000000')|| (result == undefined))) {
                setTimeout(function () {
                    alertify.confirm(
                        'Welcome to P3C!',
                        `
...
function activateUI(myCropAddress) {
    if (myCropAddress != "0x0000000000000000000000000000000000000000" || myCropAddress != undefined) {
        ...
        alertify.prompt('Error - Please reload page.')
    }
}
