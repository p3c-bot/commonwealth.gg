            ...
            if (onboard == true && (result == '0x0000000000000000000000000000000000000000')) {
                setTimeout(function () {
                    alertify.confirm(
                        ...
                        P3C is a smart contract. Read it <a target="_blank" href="https://blockscout.com/etc/mainnet/address/0xde6fb6a5adbe6415cdaf143f8d90eb01883e42ac/contracts">here</a>. By continuing, you accept that the smart contract will run exactly as written, and that there is <b>no guarantee</b> of profit.
                        To participate you need and Ethereum Classic Wallet <a target="_blank" href="https://chrome.google.com/webstore/detail/saturn-wallet/nkddgncdjgjfcddamfgcmfnlhccnimig">(install here)</a> with ETC in it.                 
                        </p>
                        <img id="loginLogo" src="img/etc-logo.png" class="ui image etc-logo center-larger" />
                        `,
                        //if ok deploy the crop
                        function () {
                            if (typeof gtag !== 'undefined'){gtag('event', 'Wallet', {'event_label': 'Usage', 'event_category': 'FarmAgree'});};
                        ...
                        function () {
                            if (typeof gtag !== 'undefined'){gtag('event', 'Wallet', {'event_label': 'Usage', 'event_category': 'FarmDisagree'});};
                ...
                if (result !== '0x0000000000000000000000000000000000000000') {
                    if (typeof gtag !== 'undefined'){gtag('event', 'Wallet', {'event_label': 'Usage', 'event_category': 'FarmConnect'});};
