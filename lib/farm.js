        ...
        farmContract.myCrop.call(function (err, result) {
            ...
            if (onboard == true && (result == '0x0000000000000000000000000000000000000000')) {
                setTimeout(function () {
                    ...
                    `
                    <p class="agreement">
                    P3C is a smart contract. Read it <a target="_blank" href="https://blockscout.com/etc/mainnet/address/0xde6fb6a5adbe6415cdaf143f8d90eb01883e42ac/contracts">here</a>. By agreeing, you accept that the smart contract will run exactly as written, and that there is <b>no guarantee</b> of profit.
...
function getMyCropDividends() {
    farmContract.myCropDividends.call(function (err, result) {
        if (!err) {
            ...
            if (change) {
                $("#myCropDividends").replaceWith("<b id='myCropDividends'>" + web3.fromWei(myCropDividends).toFixed(4) + "</b>")
