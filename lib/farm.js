...
function getMyCrop(onboard) {
    ...
    if (myCropAddress == 'null') {
        farmContract.myCrop.call(function (err, result) {
            ...
            if (onboard && (result == '0x0000000000000000000000000000000000000000')) {
                localStorage.setItem(web3.eth.accounts[0], null)
                setTimeout(function () {
                    alertify.confirm(
                    'Welcome to P3C!',
                    `
...
function activateUI(myCropAddress) {
    if (myCropAddress != "0x0000000000000000000000000000000000000000") {
