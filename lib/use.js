        ...
        if (data !== null){
            ...
            $.each(data, function (key, val) {
                ...
                if (color == "red" && key == 'usd7'){
                    if (typeof gtag !== 'undefined'){gtag('event', 'Wallet', {'event_label': 'Usage', 'event_category': 'BalanceDown'});};
                    alertify.error('Balance: <u>' + change + '</u>% down in last 7 days.',5)
                }

                if (color == "green" && key == 'usd7'){
                    if (typeof gtag !== 'undefined'){gtag('event', 'Wallet', {'event_label': 'Usage', 'event_category': 'BalanceUp'});};
                    alertify.success('Balance: <u>' + change + '</u>% up in last 7 days.',5)
                }
            });
