...
if (typeof web3 == 'undefined') {
    ...
    setTimeout(function () {
        alertify.confirm(
            'Welcome to P3C!',
            `
            <h3 class="custom-computer only">To use P3C install <a target="_blank" href="https://chrome.google.com/webstore/detail/saturn-wallet/nkddgncdjgjfcddamfgcmfnlhccnimig">Saturn wallet</a> and follow along.</h3>
    ...
    if (res !== "61") {
        ...
        setTimeout(function () {
            alertify.confirm(
                'Welcome to P3C!',
                `
                <h3 class="custom-computer only">Metamask detected. To use, install <a target="_blank" href="https://chrome.google.com/webstore/detail/saturn-wallet/nkddgncdjgjfcddamfgcmfnlhccnimig">Saturn wallet</a> and follow the video.</h3>
                <h3 class="mobile only alert-text">Mobile is still in beta. Follow Tutorial <a target="_blank" href="https://forum.saturn.network/t/how-to-setup-an-ethereum-classic-wallet-on-a-mobile-phone-using-trust-wallet/2593">here</a> or Connect from a Computer.</h3>
