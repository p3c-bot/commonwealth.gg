...
if (typeof web3 == 'undefined') {
    ...
    displayError(
        ...
        <div class="mobile only">To Use, Install an <a target="_blank" style="color: white; text-decoration: underline;" href="https://forum.saturn.network/t/how-to-setup-an-ethereum-classic-wallet-on-a-mobile-phone-using-trust-wallet/2593">ETC Wallet</a></div><a href="https://commerce.coinbase.com/checkout/80e5f38c-8210-416e-b73f-e1c84a2833cb" target="_blank" style="color: white; text-decoration: underline;">Buy</a> with BTC or ETH.`
    )
}
...
getNetworkId(web3).then(function (res) {
    if (res !== "61") {
        ...
        displayError(
            ...
            <div class="mobile only">ETH detected. Install an <a target="_blank" style="color: white; text-decoration: underline;" href="https://forum.saturn.network/t/how-to-setup-an-ethereum-classic-wallet-on-a-mobile-phone-using-trust-wallet/2593">ETC Wallet</a></div><a href="https://commerce.coinbase.com/checkout/80e5f38c-8210-416e-b73f-e1c84a2833cb" target="_blank" style="color: white; text-decoration: underline;">Buy</a> with BTC or ETH.`
        )
    } else {
